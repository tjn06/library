...
const MenuSallad = () => {
  ...
  <div>
    ...
    searchFirstLabelText="Sök på all sallad" searchSecondLabelText="Sök på ingrediens"/>
      
      <StyledCenter>
      <StyledNavMenuItem onClick={() => setCategoryFilter('alla')} >Alla</StyledNavMenuItem> | 
      <StyledNavMenuItem onClick={() => setCategoryFilter('Spansk')} >Spansk</StyledNavMenuItem> | 
      <StyledNavMenuItem onClick={() => setCategoryFilter('Grekisk')} >Grekisk</StyledNavMenuItem>
      </StyledCenter>
