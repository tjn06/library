...
const HistoryNoCollapseBlock = ({backgOne, backgTwo}, props) => {
  ...
  return (
    <div>
      ...
      <StyledHistory backgAlt={backgAlt} backgOne={backgOne} backgTwo={backgTwo}>
...
export default HistoryNoCollapseBlock